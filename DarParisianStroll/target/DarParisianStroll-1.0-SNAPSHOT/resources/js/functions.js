...
function initialize() {
	map = new google.maps.Map(document.getElementById("map_canvas"), {
		zoom : 13,
		center : new google.maps.LatLng(48.87, 2.347198),
	...
	montMartreMarker = new google.maps.Marker({
		position : new google.maps.LatLng(48.887691, 2.340607),
		icon : goldStar,
		map : map
	});
	
	//arcDeTriompheIcon = 'http://www.premiumtours.co.uk/images/product/original/68_1.jpg';
	arcDeTriopheMarker = new google.maps.Marker({
		position : new google.maps.LatLng(48.873756, 2.294946),
