...
<html lang="fr">
    ...
    <jsp:include page="../import.jsp"></jsp:include>
		...
		<link rel="stylesheet" href="<c:url value="/resources/css/activites/liste_activites.css"/>" media="screen"/>
		<script src="<c:url value="/resources/js/activites/liste_activites.js" />"></script>
